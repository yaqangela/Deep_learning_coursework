...
#         self.convolutional_layers = [Conv1d(num_input_channels, num_channels[0], kernel_sizes[0], strides[0], weight_init_fn=conv_weight_init_fn, bias_init_fn=bias_init_fn)]
...
#         self.linear_layer = Linear(in_features = num_channels[-1] *current_width, out_features= num_linear_neurons, weight_init_fn=conv_weight_init_fn, bias_init_fn=bias_init_fn)
